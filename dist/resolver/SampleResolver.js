...
__decorate([
    type_graphql_1.Query((returns) => Date),
...
__decorate([
    ...
    __metadata("design:returntype", notifications_type_1.Notification)
], SampleResolver.prototype, "normalSubscription", null);
__decorate([
    type_graphql_1.Subscription((returns) => notifications_type_1.Notification, {
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg("topic")),
